...
def redeem_coupon(db: Session, user_id: int, business_code: str):
    ...
    business_id = code_validation["business_id"]
...
def get_user_redemption_summary(db: Session, user_id: int):
    ...
    return {
        ...
        "is_subscription_active": subscription.is_active and subscription.expires_at > datetime.utcnow(),
    }
